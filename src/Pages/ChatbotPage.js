...
import BotImage from "../assets/bot-image.webp"; // Update this to your actual logo path
import Logo from "../assets/microsoft-logo.png"; // Update this to your actual logo path
import { useNavigate } from "react-router-dom";

function ChatbotPage() {
  const userName = localStorage.getItem('username')?? "teman"; // Change to the logged-in user's name
  const [messages, setMessages] = useState([
    { text: `Halo, ${userName}! Ada yang bisa saya bantu hari ini?`, isUser: false },
  ]);
